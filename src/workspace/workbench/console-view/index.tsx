import { IDockviewPanelProps } from "@/components/custom/dockview-core";
    ...
    useEffect(() => {
        if (terminalRef?.current && !termRef?.current) {
            ...
            dockerEvent.on("run", async () => {
                ...
                await axios.post(
                    "/docker/v1.37/containers/create",
                    {
                        Image: IMAGE_NAME,
                        Tty: true,
                    },
                ...
                fetch(
                    `/docker/v1.37/containers/${CONTAINER_NAME}/logs?${new URLSearchParams(
                        {
                            follow: "true",
                            stdout: "true",
                        },
